...
TIMES="10"
eval $(wget -qO- "https://raw.githubusercontent.com/Ronyart12/vip/main/Fls/botkey")
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Ronyart12/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Ronyart12/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Ronyart12/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Ronyart12/vip/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Ronyart12/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Ronyart12/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/Ronyart12/vip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/Ronyart12/vip/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/Ronyart12/vip/main/Cfg/m-noobz 
...
cat >/etc/cron.d/daily_backup <<-END
		0 12,21 * * * root /usr/local/bin/daily_backup
	END
